...
Robot::Robot() {
    base = Stepper(STEPPER_CHANNEL, STEPPER_STEPS, STEPPER_MIN_POS, STEPPER_MAX_POS, new Potentiometer(POTENTIOMETER_PIN, POTENTIOMETER_MIN_LIMIT, POTENTIOMETER_MAX_LIMIT));
